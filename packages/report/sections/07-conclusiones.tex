...
El sistema difuso Mamdani propuesto modela el riesgo académico como una transición gradual entre conjuntos lingüísticos. La combinación de funciones de pertenencia triangulares y trapezoidales, treinta reglas IF-THEN calibradas con cobertura exhaustiva en grid realista, agregación máximo y defuzzificación centroide produce un resultado numérico explicable y reproducible, sin recurrir a aprendizaje automático ni estadística predictiva.
